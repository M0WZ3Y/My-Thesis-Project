"""
Enhanced PJM Electricity Price Prediction Models - TensorFlow-Free Version
Clean version with no TensorFlow imports - completely sklearn-based
"""
...
class EnhancedPJMPricePredictor:
    ...
    TensorFlow-free version - uses only sklearn and statsmodels
    """
    ...
    def load_data(self):
        ...
        print("TensorFlow-Free Version - Sklearn Only")
        print("=" * 60)
